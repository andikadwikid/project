...
export const products: Product[] = [
  {
    ...
    brand: "Bella Rosa",
    description:
      "Sepatu hak tinggi dengan finishing rose gold yang elegan. Cocok untuk acara formal dan pesta malam.",
  ...
  },
  {
    ...
    brand: "Femme Chic",
    description:
      "Pumps hitam klasik yang timeless. Essential untuk setiap wanita profesional.",
  ...
  },
  {
    ...
    brand: "Grace Steps",
    description:
      "Sneakers dengan warna pastel pink yang soft dan feminin. Nyaman untuk aktivitas sehari-hari.",
    sizes: ["36", "37", "38", "39", "40"],
  ...
  },
  {
    ...
    brand: "Bella Rosa",
    description:
      "Ballet flats dengan warna nude yang versatile. Cocok dipadukan dengan berbagai outfit.",
  ...
  },
  {
    ...
    brand: "Femme Chic",
    description:
      "Ankle boots dengan warna burgundy yang rich dan sophisticated. Perfect untuk musim dingin.",
    sizes: ["36", "37", "38", "39", "40"],
  ...
  },
  {
    ...
    brand: "Grace Steps",
    description:
      "Platform sneakers putih yang trendy dan memberikan tinggi ekstra dengan nyaman.",
    sizes: ["36", "37", "38", "39", "40"],
    colors: ["White", "Cream"],
    isNew: true,
    isSale: false,
